...
def create_app_ui():
    ...
    dcc.Tabs(id="Tabs",value="Map",children=[
        dcc.Tab(label="Map tool",id="Map tool",value="Map",children=[
            dcc.Tabs(id="subtabs",value="WorldMap",children=[
                ...
                ],colors={"border":"Maroon",
                          "Primary":"gold",
                          "background":"Lime"}),          
            dcc.Dropdown(id='month',
                         options=month_list,
                         placeholder='select month',
                         style={'font-family':('Impact','sans-serif'),'textAlign':'center','Width':'50px','font-size':'20px','letter-spacing':'2px'},
                         multi=True),
            ...
            style={'font-size':'20px','color':'Maroon'}),
        ...
        dcc.Tab(label="Chart Tool",id="chart tool",value="Chart",children=[
            dcc.Tabs(id="subtabs2",value="WorldChart",colors={"border":"Maroon",
                          "Primary":"gold",
                          "background":"Lime"},children=[
    ...
    html.Div(id="graph_object",children="Graph will be shown here",style={'color':'Maroon'})
    ])
    return main_layout
...
@app.callback(
    ...
    [
     ...
     dash.dependencies.Input('attack_type-dropdown','value'),
...
def update_app_ui(Tabs,month_value,date_value,region_value,country_value,
                  state_value,city_value,attack_type_value,year_value,
                  chart_year_selector,chart_dp_value,search,
                   subtabs2):
    fig=None
    if Tabs=="Map":
        ...
        print("Data Type of Attack value=",str(type(attack_type_value)))
        print("Data of Attack value=",attack_type_value)
